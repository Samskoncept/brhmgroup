...
trait Text {
  ...
  public static function text_markup() {
    ...
    ?>
<!-- <div class="darklup-row <?php echo esc_html( $args['class'] ); ?>" data-condition="<?php echo esc_html($conditionData); ?>">
      <div class="darklup-col-lg-6 darklup-col-md-12">
        <div class="input-area">
          <div class="darklup-single-input-inner style-two">
              ...
              ?>
              <input id="darklup_<?php echo esc_attr( $fieldName ); ?>" class="<?php echo esc_attr( $args['class'] ); ?>" type="text" name="<?php echo esc_attr( $optionName ).'['.$fieldName.']'; ?>" placeholder="<?php echo esc_attr( $args['placeholder'] ); ?>" value="<?php echo esc_html( $value ); ?>">
          </div>
        </div>
      </div>
    </div> -->
