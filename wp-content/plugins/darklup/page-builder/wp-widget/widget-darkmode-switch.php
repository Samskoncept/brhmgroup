...
class Darklup_Darkmode_Switch extends WP_Widget {
...
'darklup_darkmode_switch_widget', 


// Widget name will appear in UI
esc_html__( 'Darkmode Switch [Darklup]', 'darklup' ),

// Widget description
array( 'description' => esc_html__( 'Select darkmode switch.', 'darklup' ), ) 
);
...
echo wp_kses_post( $args['before_title'] . $title . $args['after_title'] );
	...
	// Switch style 
	echo \Darklup\Switch_Style::switchStyle( esc_html( $darkmodeSwitch ) );
...
?>
<p>
<label style="font-weight:bold;margin-bottom:10px;display: block;" for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:' ,'darklup'); ?></label> 
<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
</p>

<div class="image-select-content-wrapper">
<label style="font-weight:bold;margin-bottom:10px;display: block;" for="<?php echo esc_attr( $this->get_field_id( 'darkmode_switch' ) ); ?>"><?php esc_html_e( 'Select Switch:' ,'darklup'); ?></label> 	
<?php

$images = \Darklup\Helper::switchDemoImage();

foreach( $images as $key => $option ):
?>
<div class="darklup-image-select-item">
...
public function radio_image_style() {
	...
	<style>
		...
		.darklup-image-select-item.darklup_block-active, .darklup-image-select-item img:hover {
		    border-color: #3700B3;
		}
...
function darklup_darkmode_switch_init_widget() {
	register_widget( 'Darklup_Darkmode_Switch' );
}
add_action( 'widgets_init', 'darklup_darkmode_switch_init_widget' );
